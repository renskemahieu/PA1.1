...
Now let's commit your changes of this file `10_commit_local.md` and `my_first_file.md`. In GitHub Desktop you should see both files and the changes made. Make sure you select both of these changes and commit those changes by clicking the blue 'Commit 2 files to main'. oke lets add smth
...
![Git history](https://github.com/TUDelft-MUDE/source-files/raw/main/file/mermaid-diagram-PA1_1_10.png)

You can get a visualization of this commit history in VS code under the 'source control' tab in the 'Graph' panel.

![Git history](https://github.com/TUDelft-MUDE/source-files/raw/main/file/git_history_vs_code.jpg)
